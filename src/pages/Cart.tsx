        ...
        <div className="p-6 bg-white rounded-lg shadow-md">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-2">
              <button onClick={handleDecrease} className="text-blue-500 hover:text-blue-700">
                <svg
              ...
              <button onClick={handleIncrease} className="text-blue-500 hover:text-blue-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5"
                  viewBox="0 0 20 20"
          ...
          <button onClick={() => console.log('Remove clicked')} className="text-red-500 hover:text-red-700">
            Remove
          </button>
        </div>
