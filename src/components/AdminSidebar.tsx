  ...
  return (
    <nav className="fixed left-0 w-64 h-full p-4 text-white bg-gray-800">
      ...
      <ul>
        ...
        <li className="mb-2">
          <Link to="/admin/categories" className="text-gray-300 hover:text-white">Categories</Link>
        </li>
        <li className="mb-2">
          <Link to="/admin/products" className="text-gray-300 hover:text-white">Products</Link>
        </li>
        <li className="mb-2">
